      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
            {/* <div>
              <h3 className="text-lg font-semibold mb-4 text-luxima-gold leading-[125%]">Company</h3>
              <ul className="space-y-2">
                <li><a href="/luxima/about" className="text-gray-400 hover:text-white transition duration-300 leading-[125%]">About Us</a></li>
                <li><a href="/luxima/team" className="text-gray-400 hover:text-white transition duration-300 leading-[125%]">Our Team</a></li>
                <li><a href="/luxima/careers" className="text-gray-400 hover:text-white transition duration-300 leading-[125%]">Careers</a></li>
              </ul>
            </div> */}
            <div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
          <p className="leading-[125%]">© {new Date().getFullYear()} PT Bangun Laksana Persada. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
