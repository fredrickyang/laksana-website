          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-10 lg:gap-16">
            ...
            <div className="md:col-span-2 space-y-3">
              ...
              <ul className="space-y-2 text-neutral-600">
                <li>
                  <a href="#" className="hover:text-neutral-900 transition-colors">Tentang Kami</a>
                </li>
                <li>
                  <a href="#" className="hover:text-neutral-900 transition-colors">Produk</a>
                </li>
                <li>
                  <a href="#" className="hover:text-neutral-900 transition-colors">Fasilitas</a>
                </li>
              </ul>
            </div>
            ...
            <div className="md:col-span-2 space-y-3">
              ...
              <ul className="space-y-2 text-neutral-600">
                <li>
                  <a href="#" className="hover:text-neutral-900 transition-colors">Artikel</a>
                </li>
                <li>
                  <a href="/our-company#progress" className="hover:text-neutral-900 transition-colors">Progress Pembangunan</a>
                </li>
              </ul>
            </div>
              ...
              <ul className="space-y-4 text-neutral-600">
                <li>
                  <div className="flex justify-start gap-3">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-geo-alt-fill shrink-0 mt-1" viewBox="0 0 16 16">
