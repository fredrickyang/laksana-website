    ...
    <>
      ...
      <div className="relative min-h-25vh flex flex-col justify-center px-8 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <ResponsiveImage
            ...
            media={facilitiesPage?.hero?.backgroundImage}
            src={heroBackground}
      ...
      <section className="w-full mt-[5%] mb-[5%] border-y border-white/5">
        <div className="container mx-auto px-8 text-center">
          ...
          <div className="text-md text-slate-600 text-justify">
            {valuesDescription.length > 0 ? valuesDescription.map((paragraph: string, index: number) => (
          ...
          <div className="card-facilities mt-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {valueCards.length > 0 ? valueCards.map((card: any, index: number) => (
              <FacilityCard
                key={index}
                title={card.title}
                description={card.description}
                imageMedia={card.image}
                imageSrc={getMediaUrl(card.image) || `/images/facilities/image${index + 1}.jpg`}
                imageAlt={card.title}
              />
            )) : (
              <>
      ...
      <div className="px-8 max-w-7xl mx-auto">
        ...
        <div className="max-w-7xl flex flex-col lg:flex-row lg:justify-center gap-8 lg:gap-0 border-t border-b border-black/10 mb-24">
          {services.length > 0 ? (
            // Render services from CMS - group into columns of 2
            services.reduce((acc: any[][], service: any, index: number) => {
              const groupIndex = Math.floor(index / 2);
              if (!acc[groupIndex]) acc[groupIndex] = [];
              acc[groupIndex].push(service);
              return acc;
            }, []).map((group: any[], groupIndex: number) => (
              <div key={groupIndex} className={`divide-y ${groupIndex < 2 ? 'lg:border-r' : ''} divide-black/10 border-black/10`}>
                {group.map((service: any, serviceIndex: number) => (
                  <div key={serviceIndex} className="px-12 py-8">
                    <div className="flex items-center gap-4 mb-6">
                      <div className="w-12 h-12 rounded-full flex items-center justify-center bg-black/10">
                        {service.icon && getMediaUrl(service.icon) ? (
                          <img src={getMediaUrl(service.icon)} alt={service.title || "Service"} width={24} height={24} className="w-6 h-6" loading="lazy" decoding="async" />
                        ) : (
                      ...
                      <div>
                        <div className="font-bold text-black">{service.title}</div>
                        <div className="text-sm text-neutral-600">{service.subtitle}</div>
                      </div>
                    </div>
                    <div className="leading-relaxed text-neutral-700 pl-5">
                      <ul className="list-disc">
                        {service.featuresList?.map((feature: any, featureIndex: number) => (
            ...
            <>
              ...
              <div className="divide-y lg:border-r divide-black/10 border-black/10">
                <div className="px-12 py-8">
                  <div className="flex items-center gap-4 mb-6">
                    <div className="w-12 h-12 rounded-full flex items-center justify-center bg-black/10">
                      <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" className="bi bi-wifi" viewBox="0 0 16 16">
                    ...
                    <div>
                      <div className="font-bold text-black">Internet Fiber Optic</div>
                      <div className="text-sm text-neutral-600">Koneksi Internet Cepat & Stabil</div>
                    </div>
                  </div>
                  <div className="leading-relaxed text-neutral-700 pl-5">
                    <ul className="list-disc">
                ...
                <div className="px-12 py-8">
                  <div className="flex items-center gap-4 mb-6">
                    <div className="w-12 h-12 rounded-full flex items-center justify-center bg-black/10">
                      <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="h-6 w-6 text-black">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-neutral-600">Gudang dengan Konsep 4 in 1</div>
                    </div>
                  </div>
                  <div className="leading-relaxed text-neutral-700 pl-5">
                    <ul className="list-disc">
              ...
              <div className="divide-y lg:border-r divide-black/10 border-black/10">
                <div className="px-12 py-8">
                  <div className="flex items-center gap-4 mb-6">
                    <div className="w-12 h-12 rounded-full flex items-center justify-center bg-black/10">
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-p-circle" viewBox="0 0 16 16">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-neutral-600">Area Parkir Luas dan Aman</div>
                    </div>
                  </div>
                  <div className="leading-relaxed text-neutral-700 pl-5">
                    <ul className="list-disc">
                ...
                <div className="px-12 py-8">
                  <div className="flex items-center gap-4 mb-6">
                    <div className="w-12 h-12 rounded-full flex items-center justify-center bg-black/10">
                      <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" className="bi bi-lightning" viewBox="0 0 16 16">
                        <path d="M5.52.359A.5.5 0 0 1 6 0h4a.5.5 0 0 1 .474.658L8.694 6H12.5a.5.5 0 0 1 .395.807l-7 9a.5.5 0 0 1-.873-.454L6.823 9.5H3.5a.5.5 0 0 1-.48-.641zM6.374 1 4.168 8.5H7.5a.5.5 0 0 1 .478.647L6.78 13.04 11.478 7H8a.5.5 0 0 1-.474-.658L9.306 1z" />
                      </svg>
                    </div>
                    <div>
                      <div className="font-bold text-black">Listrik Stabil</div>
                      <div className="text-sm text-neutral-600">Terdapat pilihan besaran listrik</div>
                    </div>
                  </div>
                  <div className="leading-relaxed text-neutral-700 pl-5">
                    <ul className="list-disc">
              ...
              <div className="divide-y divide-black/10">
                <div className="px-12 py-8">
                  <div className="flex items-center gap-4 mb-6">
                    <div className="w-12 h-12 rounded-full flex items-center justify-center bg-black/10">
                      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-shield" viewBox="0 0 16 16">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-neutral-600">Sistem Keamanan Terintegrasi CCTV</div>
                    </div>
                  </div>
                  <div className="leading-relaxed text-neutral-700 pl-5">
                    <ul className="list-disc">
                ...
                <div className="px-12 py-8">
                  <div className="flex items-center gap-4 mb-6">
                    <div className="w-12 h-12 rounded-full flex items-center justify-center bg-black/10">
                      <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" className="bi bi-geo" viewBox="0 0 16 16">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-neutral-600">Berada di Lokasi Strategis & Berkembang</div>
                    </div>
                  </div>
                  <div className="leading-relaxed text-neutral-700 pl-5">
                    <ul className="list-disc">
