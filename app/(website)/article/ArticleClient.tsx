...
const defaultArticles = [
  {
    id: 1,
    thumbnail: "images/card-blog/tahap3.png",
    category: "News",
  ...
  {
    id: 2,
    thumbnail: "images/card-blog/iuki.png",
    category: "Tips & Trick",
    title: "Kawasan Industri dengan Izin Lengkap (UIKI)",
    excerpt: "Memiliki izin lengkap (UIKI) memberikan kemudahan bagi perusahaan dalam menjalankan operasional bisnisnya di kawasan industri.",
    slug: "kawasan-industri-izin-lengkap",
  },
  {
    id: 3,
    thumbnail: "images/card-blog/estate-terbaik.png",
    category: "Article",
...
export default function ArticleClient({ articles: cmsArticles, settings }: ArticleClientProps) {
  ...
  // Helper to get category name (handles both string and relationship object)
